...
from src.Graph.graph import Graph, GraphException, PHY_MAT
...
class TestAdjMat(TestCase):
    ...
    def test_delete_node(self):
        g1 = AdjMat.make(GRAPH_CASES["circle"])
    ...
    def test_delete_edge(self):
        ...
        :return:
        """
        g = AdjMat.make(GRAPH_CASES["4-complete"])
    ...
    def test_nodes(self):
        def test_node(label:str, case):
            ...
            g = Graph.make(type=PHY_MAT, edges=case)
